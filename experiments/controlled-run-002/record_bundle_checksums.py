#!/usr/bin/env python3
"""Build or verify the sanitized checksum manifest for controlled run 002."""
...
COMPARISON_CASE_ID = "controlled-run-002"
...
def main() -> int:
    ...
    if args.check:
        ...
        if MANIFEST_PATH.read_text(encoding="utf-8") != rendered:
            ...
            return 1
        print("controlled-run-002 checksum manifest is current")
        return 0
    if args.write:
