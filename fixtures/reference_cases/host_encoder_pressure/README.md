# Host Encoder Pressure

This directory is a deterministic synthetic reference fingerprint for P0 software testing.
...
Expected artifact: a synthetic reference fingerprint.
