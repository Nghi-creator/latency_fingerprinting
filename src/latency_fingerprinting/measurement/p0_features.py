...
P0_FEATURE_CONFIG: Mapping[str, FeatureNormalizationConfig] = MappingProxyType(
    {
        "client.available_incoming_bitrate_kbps": FeatureNormalizationConfig(
            unit="kbps", epsilon=1.0
        ),
